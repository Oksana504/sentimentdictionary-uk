...
Важливо❗️❗️❗️ </br>
▶️ Це лише перші версії Словника. Найближчим часом будуть представлені релізи з доповненнями.
</br>
▶️ Омонімія у перших двох версіях Словника ще не знята.
</br>
...
👉 В такий спосіб було надано інформацію для **14 857** слів та словосполучень, які і представлено у другій версії Словника. </br>

## UPDATES
✅️ у файлі "tonSUM.1.0.txt" представлено Словник у вигляді таблиці (кодування **ANSI**); </br>
✅️ у файлі "tonSUM-utf8.1.0.txt" представлено Словник у вигляді таблиці (кодування **utf-8**, як і зазначено у самій назві файлу); </br>
</br>
